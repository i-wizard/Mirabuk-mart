...
def fourth(request):
    ...
    sc5=int(request.POST['sco5'])
    sc6=int(request.POST['sco6'])
    total_val_add =(val3+val4+val5+val6)
    total_val =(val3, val4, val5, val6)
    total_sc = (sc3, sc4, sc5, sc6)
    total_val_sc = 0
    for i in range(4):
        val = total_val[i]
        sc = total_sc[i]
...
def fifth(request):
    ...
    sc5=int(request.POST['sco5'])
    sc6=int(request.POST['sco6'])
    total_val_add =(val2+val3+val4+val5+val6)
    total_val =(val2, val3, val4, val5, val6)
    total_sc = (sc2, sc3, sc4, sc5, sc6)
    total_val_sc = 0
    for i in range(5):
        val = total_val[i]
        sc = total_sc[i]
